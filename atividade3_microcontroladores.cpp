...
#define TOPICO_PUBLISH   "time1/temperatura"  
...
*/
#define ID_MQTT  "INCB_Teste_MQTT"     
int verm = 21;
int verd = 22;
int azul = 23;
/* Note que essas infomaçoes só vao ser utilizadas quando formos realizar a segunda parte.*/
/*  Variáveis e constantes globais */
/* SSID / nome da rede WI-FI que deseja se conectar */
const char* SSID = "walenildo"; 
...
void reconnect_mqtt(void) 
{
    while (!MQTT.connected()) 
    {
        ...
        else
        {
            ...
            Serial.println("Havera nova tenta/* code */tica de conexao em 2s");
            delay(2000);
        }
    }
}
...
{   
    ...
    MQTT.publish(TOPICO_PUBLISH, "Mensagem de teste");
